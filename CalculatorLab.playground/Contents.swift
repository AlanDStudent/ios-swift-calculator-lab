...
print(String(Int(num1)) + " % " + String(Int(num2)) + " = " + String(answer))
...
print(String(Int(num1)) + " / " + String(Int(num2)) + " + " + String(Int(num3)) + " % " + String(Int(num4)) + " = " + String(answer))
...
print("The value of pi is approximately " + String(pi))
